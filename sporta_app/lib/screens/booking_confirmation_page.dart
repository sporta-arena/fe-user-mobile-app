...
class _BookingConfirmationPageState extends State<BookingConfirmationPage> {
  ...
  Future<void> _createBooking() async {
    ...
    // Debug: print payment method being sent
    ...
    debugPrint('Time: ${widget.selectedTimeSlots.first}');
    debugPrint('Duration: $_durationHours hours');
    debugPrint('====================');
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    "• Refund hanya dapat dilakukan jika lebih dari 3 hari (H-3) sebelum jadwal booking",
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: Colors.grey[700],
                                      height: 1.4,
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                    "• Jika sudah memasuki H-3, booking tidak dapat di-refund",
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: Colors.grey[700],
                                      height: 1.4,
                                  ...
                                  const SizedBox(height: 4),
                                  Text(
                                    "• Refund 100% dari harga lapangan (biaya admin & platform tidak dapat di-refund)",
                                    style: TextStyle(
                                      fontSize: 12,
                                      color: Colors.grey[700],
                                      height: 1.4,
...
class _BookingCreatedPageState extends State<BookingCreatedPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _simulatePaymentSuccess() async {
    // Call API to actually update booking status in database
    setState(() => _isCheckingStatus = true);
    ...
    if (mounted) {
      ...
      if (result.success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(result.message ?? 'Gagal simulasi pembayaran'),
            backgroundColor: Colors.red,
          ),
        );
      }
