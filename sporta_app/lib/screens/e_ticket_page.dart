...
class _ETicketPageState extends State<ETicketPage> {
  ...
  bool get _canRequestRefund {
    ...
    // Check if more than 3 days (H-3) before booking
    try {
      ...
      // Can only refund if more than 3 days before booking
  ...
  String get _refundTimeInfo {
    try {
      ...
      if (diff.isNegative) {
        ...
        return "Refund 100% tersedia (${diff.inDays} hari sebelum jadwal)";
      } else {
        return "Refund tidak tersedia (sudah memasuki H-3 sebelum jadwal)";
      }
    } catch (e) {
      return "";
    }
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const SizedBox(height: 8),
                            Text(
                              "Kebijakan: Refund 100% jika > 3 hari (H-3) sebelum jadwal. Jika sudah memasuki H-3, tidak dapat di-refund.",
                              style: TextStyle(
