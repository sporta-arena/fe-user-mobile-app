...
class RefundPolicy {
  ...
  static RefundPolicy calculate(DateTime bookingDateTime) {
    ...
    if (diff.inHours >= 24) {
      return RefundPolicy(
        percentage: 100,
        description: 'Refund 100% (pembatalan > 24 jam sebelum jadwal)',
        canRefund: true,
      );
    }
    ...
    if (diff.inHours >= 12) {
      return RefundPolicy(
        percentage: 50,
        description: 'Refund 50% (pembatalan 12-24 jam sebelum jadwal)',
        canRefund: true,
      );
    }
    ...
    return RefundPolicy(
      percentage: 0,
      description: 'Tidak dapat refund (< 12 jam sebelum jadwal)',
      canRefund: false,
    );
  }
}
